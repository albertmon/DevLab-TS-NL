...
// <div class="media" data-src="media/logo.png" style="width: 177px; height: 60px" />
...
public class MediaReplacedElementFactory implements ReplacedElementFactory {
	...
	public ReplacedElement createReplacedElement(
		...
		if ("div".equals(nodeName) && "media".equals(className)) {
			...
			try {
				ClassPathResource cpr = new ClassPathResource("/img/" + element.getAttribute("data-src"));
				
				final byte[] bytes = IOUtils.toByteArray(cpr.getInputStream());
